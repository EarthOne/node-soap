...
WSSecurity.prototype.toXML = function() {
  ...
  return "<wsse:Security " + (this._actor ? (this._envelopeKey || 'soap') + ":actor=\"" + this._actor + "\" " : "") +
    (this._mustUnderstand ? (this._envelopeKey || 'soap') + ":mustUnderstand=\"1\" " : "") +
